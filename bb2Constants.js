...
// Triggers which Array BB2Accessory will be placed
// Either bb2Accessories or bb2StandaloneAccessories
//
...
var bb2Constants = {
   ...
   ERROR_STRINGS:
   [ // bb2Constants.ERROR_TIMER_EXPIRED -151
     "Timer expired contacting accessory",
     // bb2Constants.ERROR_CMD_FAILED_REPLY -152
     "Command failed",
     // bb2Constants.ERROR_NULL_REPLY -153
     "Reply is NULL",
     // bb2Constants.ERROR_NULL_STRING_REPLY -154
     "Reply is NULL string",
     // bb2Constants.ERROR_EMPTY_STRING_REPLY -155
     "Reply is an empty string",
     // bb2Constants.ERROR_2ND_NULL_STRING_REPLY -156
     "Reply is still NULL",
     // bb2Constants.ERROR_NON_CONVERTABLE_REPLY -157
     "Cannot convert characteristic string",
     // bb2Constants.ERROR_NO_DATA_REPLY -158
   ...
   {
      let offset = - index + bb2Constants.ERROR_STRING_MIN ;
      let max = bb2Constants.ERROR_STRING_MIN - bb2Constants.ERROR_STRING_MAX;
      ...
      if ( index > bb2Constants.ERROR_STRING_MIN )
         return "Device returned its own error; " + index;
      if ( index < bb2Constants.ERROR_STRING_MAX )
         return "Device returned its own error; " + index;
      ...
      return bb2Constants.ERROR_STRINGS[ offset ];
   },
